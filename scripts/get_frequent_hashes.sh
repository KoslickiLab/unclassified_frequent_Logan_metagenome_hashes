...
python logan_hash_tools.py percentiles \
  ...
  --map-out /scratch/dmk333_new/unclassified_frequent_Logan_metagenome_hashes/data/hash_and_sample_id_counts/hash_counts_{$BOTTOMP}_{$TOPP}/hash_pct_{$BOTTOMP}_{$TOPP}_pairs \
  --attach-db /scratch/shared_data_new/Logan_yacht_data/processed_data/database_all.db \
  --db-schema sigs_dna --db-table siganture_mins --attach-alias ro \
  --ksize 31 \
